    ...
    */
        ...
        for (var i = 0; i < overlaps.length; i++) {
            ...
            if (overlap.vertices.length === 1) {
                ...
                if (overlap.rings.length === 2) {
                    ...
                    let midpoint = SmilesDrawer.Vector2.midpoint(positions[0], positions[1]);
    ...
    createNextBond(vertex, previousVertex, ringOrAngle, dir) {
        ...
        if (!previousVertex) {
            ...
            let pos = SmilesDrawer.Vector2.subtract(ringOrAngle, previousVertex.position);
            pos.normalize();
