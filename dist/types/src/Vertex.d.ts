...
export default class Vertex {
     ...
     */
    getAngle(referenceVector?: Vector2, returnAsDegrees?: boolean): number;
    /**
     ...
     */
    getTextDirection(vertices: Vertex[], onlyHorizontal?: boolean): string;
    /**
     ...
     */
    getNeighbours(vertexId?: number): number[];
    /**
     ...
     */
    getSpanningTreeNeighbours(vertexId?: number): number[];
    /**
     ...
     */
    getNextInRing(vertices: Vertex[], ringId: number, previousVertexId: number): number;
}
